...
public class OpenCart {
	public static void main(String[] args) {
		...
		driver.findElement(By.xpath("//input[@name='firstname']")).sendKeys("Deva");
		driver.findElement(By.xpath("//input[@name='lastname']")).sendKeys("S");
		driver.findElement(By.xpath("//input[@name='email']")).sendKeys("jagandeva1604@gmail.com");
